...
FORWARD_CHANNEL_ID = -1002423336765
CHANNEL_ID = -1002423336765
error_channel_id = -1002423336765
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: Here u Paste yiur own link*", parse_mode='Markdown')
